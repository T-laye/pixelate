...
export default function Card({ number, icon, heading, text, w = "min-w-16" }) {
  return (
    <div
      data-aos="flip-right"
      data-aos-delay="100"
      className="mb-16 w-3/4 max-[300px]:h-[300px] max-w-[270px] h-[250px] lg:min-w-[400px] lg:min-h-[354px] relative  bg-gradient-pink border border-primary rounded-md p-5 mx-auto"
    >
